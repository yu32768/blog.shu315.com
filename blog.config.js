...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'shu315', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'shu315', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.shu315.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog,博客,shu315', // 网站关键词 英文逗号隔开
